...
class ConfigSource:
    ...
    def get_subconfig(
        ...
        Example:
            ...
            >>> display_widths_copy = default.get_subconfig(
            ...     'show', 'column_widths', copy=True)
            >>> assert (
            ...     display_widths.conf_dict
            ...     == display_widths_copy.conf_dict
            ...     is not display_widths.conf_dict
            ... )
        """
        new_dict = cast(
            Dict[str, Any],
